# -*- coding: utf-8 -*-
{
    ...
    Ensuite, il convient de selectionner les clients pour lesquels on veut avoir la traçabilité GOODPayeur®.
    ...
    *A noter qu'il faut que le contact ait un numero de siren valide, sinon il ne se passera rien.*
    ...
    Quand on fait une facture à ce client, alors, un jour aprés la validation de celle ci, elle est envoyée à GOODPayeur®.
